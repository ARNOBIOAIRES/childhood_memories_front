...
//return <div className="flex flex-col gap-10">{JSON.stringify(memories)}</div>
              ...
              memories.map((memory) => {
                return (
                  <div key={memory.id} className="space-y-4">
                    ...
                    <Image src={memory.coverUrl} width={580} height={280} alt="fdsfdsfd" className="w-full aspect-video object-cover rounded-lg" />
